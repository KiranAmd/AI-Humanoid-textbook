...
/**
 * ChatWidget component that provides a floating chat interface for interacting with the Physical AI Assistant.
 * Supports message history, text selection detection, and connection to the backend chatbot API.
 */
